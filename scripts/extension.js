...
class Modals{
    ...
    createModal(id, title, text){
        ...
        modal.id = id
        modal.className = "bw-modal-window"

        let close = document.createElement("button")
        close.onclick = function(){
            extension.modals.closeModal(id)
        }
        close.title = "Fermer"
        close.className = "bw-modal-close bw-nobtn"
        close.innerHTML = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 384 512"><path fill="gray" d="M376.6 84.5c11.3-13.6 9.5-33.8-4.1-45.1s-33.8-9.5-45.1 4.1L192 206 56.6 43.5C45.3 29.9 25.1 28.1 11.5 39.4S-3.9 70.9 7.4 84.5L150.3 256 7.4 427.5c-11.3 13.6-9.5 33.8 4.1 45.1s33.8 9.5 45.1-4.1L192 306 327.4 468.5c11.3 13.6 31.5 15.4 45.1 4.1s15.4-31.5 4.1-45.1L233.7 256 376.6 84.5z"/></svg>`

        let h1 = document.createElement("h1")
        h1.innerHTML = extension.utf8(title)

        let content = document.createElement("div")
        content.innerHTML = extension.utf8(text)+`<br><span class="better-settings-copyrights">Powered by Better Websites <img src="${this.ext.href+"assets/logo.png"}" class="better-settings-logo"></span>`
