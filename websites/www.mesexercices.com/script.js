...
let title = ext.utf8("Mes exercices")
...
const display_content = ext.page.getElementByXpath("/html/body/table[3]/tbody/tr/td/div/b/main/article/b/center[1]/table")

if(ext.page.elementExist(display_content)){
    display_content.parentNode.style = "display: block !important"
}
